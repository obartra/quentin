...
- **House voice avoids em dashes in anything that ships to the site** (owner's call,
  July 2026): use commas, colons, periods, or a `|` in titles instead. Keep the
  all-caps letter-spaced labels and the editorial tone. Repo docs may still use them.
...
- Do not add em dashes to site copy or shipped assets; the owner removed them
  deliberately (July 2026). Repo docs are exempt.
